...
const Testimonials = () => {
  ...
  return (
    <div className="relative top-10 bg-[#fafafa] py-10 md:py-15">
      <div className="w-full flex justify-center items-center relative">
        <div className="relative text-center z-10 space-y-5 md:space-y-10 px-4 ">
          ...
          <div className="relative inline-block">
            <div className="absolute -left-5 md:-left-4 top-[2px]  md:-top-3 z-0">
              <svg
